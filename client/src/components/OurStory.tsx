...
export default function OurStory() {
  return (
    <section id="story" className="py-4 md:py-6 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-1">
        <div className="max-w-6xl mx-auto rounded-xl p-6 md:p-8 shadow-lg border border-terra/10" style={{
          background: 'linear-gradient(0deg, rgba(200, 89, 43, 1) 0%, rgba(184, 112, 81, 1) 49%, rgba(200, 89, 43, 1) 100%)'
        }} data-aos="fade-up">
          <h2 className="text-2xl md:text-3xl font-lora text-center mb-4 text-white" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-6 items-center" data-aos="fade">
            <div className="md:col-span-2 space-y-3 text-white">
              ...
              <p className="font-bold text-white text-center font-serif text-xl md:text-2xl mt-2">
                She is our Why!
              </p>

              <p className="text-center font-medium text-sm italic text-white mt-3">
                If you or someone you love is a Zebra, welcome to the herd. <span className="inline-block align-middle ml-1"><ZebraHeart size={22} /></span>
              </p>
            </div>

            <div className="flex justify-center">
              <div className="border border-terra/30 p-1 rounded-md shadow-sm">
                <img src={fatherDaughterImg} alt="Father and daughter" className="rounded-md max-w-full h-auto" style={{ maxHeight: '200px' }} />
              </div>
            </div>
          </div>
