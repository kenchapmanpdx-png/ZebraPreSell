    ...
    <section id="story" className="py-4 md:py-10 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-1">
        <div className="max-w-6xl mx-auto rounded-xl p-4 md:p-12 shadow-lg border border-terra/10" style={{
          ...
          <h2 className="text-3xl md:text-4xl font-lora text-center mb-3 md:mb-6 text-white" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-8 items-center" data-aos="fade">
