    ...
    <section id="story" className="py-6 md:py-10 relative overflow-hidden">
      <div className="container mx-auto px-4 relative z-1">
        <div className="max-w-6xl mx-auto rounded-xl p-8 md:p-12 shadow-lg border border-terra/10" style={{
          ...
          <h2 className="text-2xl md:text-3xl font-lora text-center mb-6 text-white" data-aos="fade-up">
          ...
          <div className="grid md:grid-cols-3 gap-8 items-center" data-aos="fade">
            <div className="md:col-span-2 space-y-4 text-white">
              ...
              <p className="font-bold text-white text-center font-serif text-xl md:text-2xl mt-4">
                She is our Why!
              </p>

              <p className="text-center font-medium text-sm italic text-white mt-4">
            ...
            <div className="flex justify-center">
              <div className="border border-terra/30 p-1 rounded-md shadow-sm">
                <img src={fatherDaughterImg} alt="Father and daughter" className="rounded-md max-w-full h-auto" style={{ maxHeight: '220px' }} />
              </div>
            </div>
          </div>
