  ...
  return (
    <section className="bg-gray-50 py-10 px-8">
      <div className="max-w-3xl mx-auto text-center">
        <h2 className="text-2xl font-serif font-bold text-forest mb-4" data-aos="fade-up">🛒 Available Soon</h2>
        <p className="text-lg text-forest/80 leading-relaxed mb-4" data-aos="fade-up" data-aos-delay="200">
          ZebraWell will be available on Amazon and Shopify. Get exclusive early access and launch updates.
        </p>
        <button className="bg-cta-green text-white px-6 py-2.5 rounded-md shadow-lg hover:bg-cta-green-dark transition-all duration-300 hover:scale-[1.02] font-semibold mb-4" data-aos="fade-up" data-aos-delay="400">
          Get Notified When We Launch
        </button>
        <div className="mt-6 flex justify-center gap-4" data-aos="zoom-in" data-aos-delay="600">
