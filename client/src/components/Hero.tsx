      ...
      <div className="relative z-1">
        ...
        <div className="max-w-3xl mx-auto text-center px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6 fade-in">
            <div className="flex items-center px-3 py-1 bg-forest/40 text-forest rounded-full border border-forest/30">
              <i className="fas fa-leaf mr-2"></i>
              <span className="text-sm font-medium">All-Natural</span>
            </div>
            <div className="flex items-center px-3 py-1 bg-terra/40 text-terra-dark rounded-full border border-terra/30">
              <i className="fas fa-seedling mr-2"></i>
              <span className="text-sm font-medium">Bioavailable</span>
            </div>
            <div className="flex items-center px-3 py-1 bg-medical-blue/40 text-medical-blue rounded-full border border-medical-blue/30">
              <i className="fas fa-puzzle-piece mr-2"></i>
              <span className="text-sm font-medium">Works as a System</span>
            </div>
            <div className="flex items-center px-3 py-1 bg-sage/40 text-sage-dark rounded-full border border-sage/30">
