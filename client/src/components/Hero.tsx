      ...
      <div className="relative z-1">
        ...
        <div className="max-w-3xl mx-auto text-center px-6">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6 fade-in">
            <div className="flex items-center px-3 py-1 bg-medical-blue/10 text-medical-blue rounded-full border border-medical-blue/20">
              <i className="fas fa-leaf mr-2"></i>
              <span className="text-sm font-medium">All-Natural</span>
            </div>
            <div className="flex items-center px-3 py-1 bg-terra/10 text-terra-dark rounded-full border border-terra/20">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-6 fade-in">
            ...
            <div className="flex items-center px-3 py-1 bg-forest/10 text-forest rounded-full border border-forest/20">
