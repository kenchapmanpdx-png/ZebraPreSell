                  ...
                  <li className="flex items-start">
                    ...
                    <div className="w-full">
                      <div className="flex justify-between items-start">
                        ...
                        <span className="text-xs text-orange-600 bg-yellow-100 px-2 py-0.5 rounded ml-2 flex-shrink-0">1,500 mg</span>
                      </div>
                  ...
                  <li className="flex items-start">
                    ...
                    <div className="w-full">
                      <div className="flex justify-between items-start">
                        ...
                        <span className="text-xs text-orange-600 bg-yellow-100 px-2 py-0.5 rounded ml-2 flex-shrink-0">300 mg</span>
                      </div>
