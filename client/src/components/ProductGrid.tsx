                ...
                <div className="relative w-22 h-28 mb-2">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center flex-col">
                    <div className="relative">
                      <div className="w-12 h-12 rounded-full border-2 border-terra/40 bg-white flex items-center justify-center mb-1 relative">
                        <div className="absolute -left-3 top-1/2 w-6 h-0.5 bg-terra/40 transform -translate-y-1/2"></div>
                        <div className="absolute -right-3 top-1/2 w-6 h-0.5 bg-terra/40 transform -translate-y-1/2"></div>
